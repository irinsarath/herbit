        ...
        child: Padding(
          ...
          child: Column(
            children:[
              ...
              context, MaterialPageRoute(builder:(context) => const user_details()),
            );},
            child: Padding(
               ...
               child: Container(
                 ...
                 height: 60,
                 width:269,
                 child: Center(child: Text('View user')),

               ),
             ),),
              GestureDetector(onTap: (){Navigator.push(
    context, MaterialPageRoute(builder:(context) => const pending_details()),
                ...
                child: Container(  height: 60,
                  ...
                  width:269 ,
                  child: Center(child: Text('pending user')),
